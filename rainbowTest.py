...
def hsv_to_rgb(hue, saturation, value):
    """
    Convert HSV (Hue, Saturation, Value) color representation to RGB (Red, Green, Blue).
    
    :param hue: Hue value (0-360).
    :param saturation: Saturation value (0.0-1.0).
    :param value: Value (brightness) value (0.0-1.0).
    :return: Tuple of RGB values (red, green, blue) in the range of 0-100.
    """
    c = value * saturation
